...
wing_sound = pygame.mixer.Sound(wing_sound_path)
...
while begin:
    ...
    if is_off_screen(ground_group.sprites()[0]):
        ...
        new_ground = Ground(ground_group.sprites()[-1].rect.right)
...
while True:
    ...
    screen.blit(score_surface, (SCREEN_WIDTH // 2 - 10, 50))
...
screen.blit(game_over_surface, (SCREEN_WIDTH // 2 - 140, SCREEN_HEIGHT // 2 - 30))
pygame.display.update()
time.sleep(2)
